"""
Generate data for container perfomance test
"""
...
MAX_EXPOENT = 7
HAYSTACK_LEN = 10 ** MAX_EXPOENT
NEEDLES_LEN = 10 ** (MAX_EXPOENT - 1)
...
# complete sample, in case duplucate random numbers were discarded
